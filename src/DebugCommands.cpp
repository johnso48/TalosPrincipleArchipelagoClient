...
// ============================================================
// F7 — Unlock All Mechanics
//
// Strategy 1: BoolSet the five Unlocked_MechanicX variables
//             (save-data persistence, may not take effect until reload)
// Strategy 2: Set bAllowAllMechanics=true on ATalosWorldSettings
//             (offset 0x0560, immediate runtime override)
// Strategy 3: Zero RequiredMechanics on every CarriableComponent
//             (offset 0x02A0, brute-force removes mechanic gating)
//
// EPuzzleMechanic bitmask (from Talos_enums):
//   None=0  Time=1  Cube=2  Fan=4  Rod=8  Platform=16
// ============================================================
